...
import { UpdateOneService, getOneService } from "@/config/services";
...
function UpdateService() {
    ...
    const uploadImage = (file) => {
        const imageRef = ref(storage, `services/${file.name + v4()}`);
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        await UpdateOneService(id, values);
        setIsLoading(false);
