...
export default function Navbar({token }) {
  ...
  return (
    <nav className={` md:text-lg bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-[0.2] sticky top-0 z-20 rounded-b-xl border-b-2 border-white py-3 md:py-1  px-2 md:px-0 flex-col`}>
