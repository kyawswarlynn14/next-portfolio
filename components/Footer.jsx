...
function Footer() {
  return (
    <div className={`text-white w-full border-t-2 border-white py-4 rounded-tl-3xl`}>
      <div className="md:w-[80%] mx-auto px-2 flex flex-col items-center lg:flex-row lg:justify-between gap-6">
        ...
        <div className="text-start">
          <h4 className="text-lg mb-2 font-semibold">Navigations</h4>
